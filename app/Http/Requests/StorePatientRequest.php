...
/**
 * Validates a new patient creation request.
 *
 * Note: patient_code is intentionally NOT listed here.
 * It is auto-generated by PatientService::generatePatientCode()
 * and must never be submitted by the client.
 *
 * medical_history is accepted as a nested object and is passed
 * through to PatientService for creation in the same transaction.
 */
